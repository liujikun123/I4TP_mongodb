...
<div id="allPage">
    ...
    <div id="bd" style="height: auto;width: 800px">
        ...
        <form action="${basePath}/index/process2" method="post" id="partCreat">
            <div class="inputName"> 零件名：</div>
            <input type="text" name="partName" class="input"/><br>
            <div class="inputName"> 零件x尺寸：</div>
            <input type="text" name="part_x" class="input"/><br>
            <div class="inputName"> 零件y尺寸：</div>
            <input type="text" name="part_y" class="input"/><br>
            <div class="inputName"> 零件z尺寸：</div>
            <input type="text" name="part_z" class="input"/><br>
            <div style="position: relative; left: 450px; bottom: 260px">
                <div class="inputName"> 零件材料：</div>
                <select id="material" name="material_type" onchange="myFunction()" class="input"
                    ...
                    <option value="<%=typeVo.getMaterial_type()%>"><%=typeVo.getMaterial_type() %>
                    </option>
                ...
                <div class="inputName">零件质量：</div>
                <input type="text" name="workpiece_weight_kg" class="input"/><br>
                <div class="inputName"> 多面：</div>
                <input name="multiaspect" type="checkbox" value="true" class="checkboxHere"/>
                <div class="inputName"> 旋转体：</div>
                <input name="rotation" type="checkbox" value="true" class="checkboxHere"/><br>
            </div>
